...
function consnetRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of consnetComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function consent_4RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of consent_4Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function BlanksScreenRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of BlanksScreenComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function math_instructionRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of math_instructionComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function mathRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of mathComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Y_NScreenRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Y_NScreenComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function LSQInstructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of LSQInstructionsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function LonlinessScaleQuestionsRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of LonlinessScaleQuestionsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
